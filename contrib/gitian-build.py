...
def setup():
    ...
    if not os.path.isdir('qtum-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vuicash/qtum-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('qtum'):
        subprocess.check_call(['git', 'clone', 'https://github.com/vuicash/qtum.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/vuicash/qtum', help='Specify the URL of the repository. Default is %(default)s')
